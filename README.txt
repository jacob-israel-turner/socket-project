...
Go to the documentation and read the short section on io.emit (scroll down to 'sending and recieving events'):
http://socket.io/docs/
...
Head back over to the docs and check out the documentation on 'on':
http://socket.io/docs/
